...
alter table invoice
add constraint fk__invoice_customer_id
...
add constraint foreign key (playlist_id)
...
alter table track
add constraint foreign key (album_id)
...
alter table track
add constraint foreign key (media_type_id)
